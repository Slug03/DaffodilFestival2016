...
public class Map extends AsyncTask<HomeScreen, Void, HomeScreen> {
    ...
    @Override
    protected HomeScreen doInBackground (HomeScreen... m) {
    ...
    protected void onPostExecute(HomeScreen m) {
        // action to view pdf
